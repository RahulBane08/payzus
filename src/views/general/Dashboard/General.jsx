                        ...
                        <div className="col-lg-12">
                          <div className="row stats-cards-row">
                            <div className="col-lg-3">
                              <StatsCard title="Token Balance" pzs="221.08" />
                            </div>
                            <div className="col-lg-3">
                              <StatsCard title="Total Rewards" pzs="263.54" />
                            </div>
                            <div className="col-lg-3">
                          ...
                          <div className="row stats-cards-row">
                            <div className="col-lg-3">
                              <StatsCard title="Direct Rewards" pzs="134.08" />
                            </div>
                            <div className="col-lg-3">
                              <StatsCard title="First Level Rewards" pzs="32.20" />
                            </div>
                            <div className="col-lg-3">
                              <StatsCard title="Second Level Rewards" pzs="23.08" />
                            </div>
                            <div className="col-lg-3">
                          ...
                          <div className="row yt-thumbnail-wrapper">
